    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1"><b>Edit Question Platform</b></h4>
            ...
            {!! Form::model($questionPlatform, ['route' => ['questionPlatforms.update', $questionPlatform->id], 'method' => 'patch']) !!}
