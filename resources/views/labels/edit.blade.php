    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1"><b>Create Label</b></h4>
                <div class="flex-shrink-0">
                    <div class="form-check form-switch form-switch-right form-switch-md">
                        <a href="{{ route('labels.index') }}" class="btn btn-primary"> <i
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('labels.index') }}" class="btn btn-default">
                    @lang('crud.cancel')
                </a>
            </div>
            {!! Form::close() !!}
