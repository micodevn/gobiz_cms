    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1"><b>Chỉnh sửa buổi học</b></h4>
                <div class="flex-shrink-0">
                    <div class="form-check form-switch form-switch-right form-switch-md">
                        <a href="{{ route('lessons.index') }}" class="btn btn-primary"> <i
            ...
            <div class="card-body">
                <div class="row">
                    @include('curriculum::pages.lessons.fields')
                </div>
            </div>
