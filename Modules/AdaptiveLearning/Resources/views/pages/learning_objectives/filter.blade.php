                ...
                <form action="" method="get" class="w-100">
                    ...
                    <div class="col-12 row">
                        ...
                        <div class="form-group mb-0 col-2">
                            <div class="form-group">
                                <input value="{{request()->get('explain')}}" placeholder="Explain" name="explain" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group mb-0 col-2">
                            <div class="form-group">
                                <input value="{{request()->get('code')}}" placeholder="Code" name="code" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group mb-0 col-1">
